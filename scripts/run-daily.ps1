# AI Curation (architecture AI) daily generator - called by Windows Task Scheduler at 08:15 KST.
...
$repo = Join-Path ([Environment]::GetFolderPath('Desktop')) 'work\_inspect\ainews-curation'
Set-Location $repo
